...
/// `Default_Eob_Pt_32_Cdf`, indexed `[qctx][ptype][txClass != TX_CLASS_2D]`.
pub static EOB_PT_32: [[[[u16; 6]; 2]; 2]; Q_CTXS] = [
    [
        [
...
/// `Default_Eob_Pt_128_Cdf`, indexed `[qctx][ptype][txClass != TX_CLASS_2D]`.
pub static EOB_PT_128: [[[[u16; 8]; 2]; 2]; Q_CTXS] = [
    [
        [
...
/// `Default_Eob_Pt_512_Cdf`, indexed `[qctx][ptype][txClass != TX_CLASS_2D]`.
pub static EOB_PT_512: [[[[u16; 10]; 2]; 2]; Q_CTXS] = [
    [
        [
