use crate::{
    Codec, ColorRange, Error, ErrorKind, FrameIndex, Limits, PixelFormat, Plane, Result,
...
/// A stateful video encoder contract for muxing backends.
pub trait VideoEncoder {
    ...
    fn drain(&mut self, cancellation: &CancellationToken) -> Result<Vec<EncodedVideoSample>>;
    fn reset(&mut self) -> Result<()>;
}
