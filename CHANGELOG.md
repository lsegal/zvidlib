...
- Fix the `web_canvas` example's canvas being a fixed 1280x720 size instead of stretching to fill its container, and add an on-screen FPS counter in the top-left corner.
