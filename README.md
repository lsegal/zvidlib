...
These commands validate the portable core on both targets. Native builds include dependency-free pure-Rust HEVC Main and bounded AV1 Main lossless monochrome decoders, and the lossless monochrome AV1 encoder described above; other compressed video encoding and concrete audio codecs remain planned.
